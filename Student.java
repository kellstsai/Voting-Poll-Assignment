...
public class Student {
    ...
    public Student(int lengthOfID, int typeOfQuestion, int numberOfChoices) {
        this.identification = getRandomID(lengthOfID);
        randomizedStudentAnswer(typeOfQuestion, numberOfChoices);
    }
